...
<!-- rule:19 -->
- Keep result content out of compact live widgets, but show full final results in completion handoffs — live progress stays scannable while completed workflows still surface the answer without forcing a second user prompt.
