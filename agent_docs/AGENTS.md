...
- Keep entries direct and exact. State required behavior, boundaries, evidence, and exceptions rather than relying on a reader to infer them; link to source files or docs when detailed reference is needed.
