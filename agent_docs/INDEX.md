...
- Authoring guide: `src/authoring-guide.ts` owns on-demand workflow primitive documentation returned by `workflow_primitives`; routing prompts should stay compact and point agents to the tool.
